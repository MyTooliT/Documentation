...
- [ICOweb](https://github.com/MyTooliT/ICOweb): Can be used to visualize HDF5 files produced by itself or one of the other [software tools](#software)
